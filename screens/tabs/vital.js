...
import {Text, View, TextInput, StyleSheet, TouchableOpacity, Image, TouchableHighlight} from 'react-native';
...
const Vital = () => {
    ...
    <View style={styles.container}>
        ...
        <View>
        <Text style={styles.text} multiline> Previous Income: ${income}</Text>
        <Text style={styles.text} multiline> Previous Credit Score: {creditScore}</Text>
        <Text style={styles.text} multiline> Previous Emergency Fund: ${emergency}</Text>
        <Text style={styles.text} multiline> Previous Budget: ${budget}{'\n\n'}</Text>
        </View>
